 ...
 * Формат результата: iv_hex:ciphertext_hex
 */
...
/**
 * Создаёт GramJS клиент из строки сессии (или новый без сессии)
 */
...
/**
 * Создаёт GramJS клиент из зашифрованных данных сессии
 */
